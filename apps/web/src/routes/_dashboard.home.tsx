						...
						<div className="grid gap-3 md:grid-cols-2">
							...
							>
								<div className="p-0">
									...
									<Link
										to="/conversation"
										className="group flex w-full items-center justify-between p-2.5 transition-colors duration-300 hover:bg-neutral-100"
									>
            ...
            <div className="mt-1 mb-1 flex w-full flex-row items-center justify-between px-1">
              ...
              >
                <PhoneIcon className="size-4" />
					...
					{/* Chat Practice Block */}
					<div
						className="overflow-hidden rounded-3xl p-2.5"
						style={{
							background:
