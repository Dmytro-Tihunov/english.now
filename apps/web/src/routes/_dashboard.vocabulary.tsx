...
function VocabularyPage() {
  ...
  // Create custom list from brainstorm results
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="gap-2 bg-linear-to-r from-[#DCFF6F] to-emerald-400 font-semibold text-slate-900 shadow-[#DCFF6F]/30 shadow-lg hover:shadow-[#DCFF6F]/40 hover:shadow-xl"
            >
        ...
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <TabsList className="h-11 bg-white/80 p-1 shadow-sm backdrop-blur dark:bg-slate-800/80">
              <TabsTrigger
                value="explore"
                className="gap-2 data-[state=active]:bg-[#DCFF6F] data-[state=active]:text-slate-900"
              >
            ...
            <div className="flex gap-3">
              <div className="relative flex-1 md:w-64">
                ...
                <Input
                  ...
                  className="bg-white/80 pl-9 backdrop-blur dark:bg-slate-800/80"
                />
              </div>
              <select
                value={selectedLevel}
              ...
              <div className="flex rounded-lg border bg-white/80 p-1 backdrop-blur dark:bg-slate-800/80">
                <Button
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  {VOCABULARY_CATEGORIES.map((category) => (
                    <button
                      ...
                      className="group hover:-translate-y-1 relative overflow-hidden rounded-2xl border bg-white p-6 text-left shadow-sm transition-all hover:shadow-lg dark:bg-slate-900"
                    >
                      <div
                        className={cn(
          ...
          <TabsContent value="custom" className="space-y-8">
            {customLists.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed bg-white/50 py-16 dark:bg-slate-900/50">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-[#DCFF6F]/30 to-emerald-200/30">
                  <Layers className="h-8 w-8 text-[#DCFF6F]" />
                </div>
                <h3 className="font-semibold text-lg">No custom lists yet</h3>
                <p className="mb-6 max-w-sm text-center text-muted-foreground text-sm">
                  Create personalized vocabulary lists based on your profession,
          ...
          <TabsContent value="practice" className="space-y-8">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              {/* Quiz */}
              <Card className="overflow-hidden">
                <div className="bg-linear-to-br from-blue-500 to-cyan-600 p-6 text-white">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white/20">
              ...
              {/* Listening */}
              <Card className="overflow-hidden">
                <div className="bg-linear-to-br from-amber-500 to-orange-600 p-6 text-white">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white/20">
                    <Volume2 className="h-6 w-6" />
                  </div>
                  <h3 className="font-bold text-xl">Listening</h3>
                  <p className="mt-1 text-sm text-white/80">
                ...
                <CardContent className="p-6">
                  <div className="mb-4 flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold">{stats.total} words</span>
                  </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <TrendingUp className="h-5 w-5 text-[#DCFF6F]" />
                  Learning Progress
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="grid gap-4 sm:grid-cols-4">
                  {Object.entries(MASTERY_COLORS).map(([key, value]) => {
                    const count = SAMPLE_WORDS.filter(
                      (w) => w.mastery === key
                    ).length;
                    return (
                      <div key={key} className={cn("rounded-xl p-4", value.bg)}>
                        ...
                        <div className={cn("text-sm", value.text)}>
                          {value.label}
                        </div>
                      </div>
                    );
