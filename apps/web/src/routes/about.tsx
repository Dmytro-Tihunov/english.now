...
export default function About() {
  return (
    <div className="relative h-full">
      <div className="container relative z-10 mx-auto max-w-3xl px-4 py-2 pt-18">
        {/* Header */}
        <div className="mb-16 flex flex-col items-center text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#C6F64D]/30 bg-[#C6F64D]/10 px-4 py-1.5 text-sm">
            <span className="font-medium text-[#7a9a2e]">Our Story</span>
          </div>
          <h1 className="mb-6 font-bold font-lyon text-4xl tracking-tight md:text-5xl">
            Why I'm Building <br className="hidden sm:block" />
            English Now
          </h1>
        </div>
        ...
        <article className="prose prose-lg mx-auto max-w-none">
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            ...
            <p>
              After years of struggling, I finally became fluent — but not
              through any app or course. It happened when I started having real
            ...
            <p>
              ...
              patient friend. It never judges your mistakes, it's available
              24/7, and it adapts to exactly where you are in your learning
              journey.
            </p>
          </div>
        </article>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Practice speaking with AI that responds naturally, just like
                    a real conversation partner.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Personalized learning paths that adapt to your level and
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Practice anytime, anywhere. Your AI language partner is
                    ready when you are.
                  </p>
                </div>
              </div>
        ...
        <div className="mb-20 text-center">
          <p className="mb-2 text-muted-foreground">
            Join me on this journey to make English learning better for
            everyone.
          </p>
          <a
            ...
            className="inline-flex items-center gap-2 font-medium text-foreground underline underline-offset-4 transition-colors hover:text-[#7a9a2e]"
          >
            Follow along on X
            <svg
