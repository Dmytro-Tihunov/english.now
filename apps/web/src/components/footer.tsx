			...
			<div className="container relative z-10 mx-auto max-w-5xl px-4">
				<div className="mx-auto grid grid-cols-3 border-border/50 border-t pt-12">
					<div className="col-span-1">
						<Link to="/" className="mb-4 flex items-center gap-3">
							<div className="relative size-8 overflow-hidden rounded-xl border border-border/50 bg-neutral-100">
								<svg
						...
						<div className="mb-4 text-muted-foreground text-sm">
							...
							learning platform. It's not ready yet, but{" "}
              ...
              <div className="flex flex-col items-center gap-3.5">
                <div className="flex items-center gap-1">
                  <span className="font-medium text-muted-foreground/75 text-sm">
                    CEFR
                  </span>
                  <svg
                    width="16"
						...
						<div className="grid grid-cols-3 gap-2">
							...
							<div className="flex flex-col">
								...
								<ul className="flex flex-col gap-2 text-sm">
									<li>
										<a
											className="group flex items-center gap-1.5 text-muted-foreground leading-6 hover:text-gray-900"
											href="https://english.userjot.com/board"
											target="_blank"
											rel="noopener noreferrer"
										>
											Feedback
											<ExternalLinkIcon className="hidden size-4 transition-all duration-300 group-hover:block" />
										</a>
									</li>
									<li>
										<a
											className="group flex items-center gap-1.5 text-muted-foreground leading-6 hover:text-gray-900"
											href="https://english.userjot.com/roadmap"
											target="_blank"
											rel="noopener noreferrer"
										>
											Roadmap
									...
									<li>
										<a
											className="group flex items-center gap-1.5 text-muted-foreground leading-6 hover:text-gray-900"
											href="https://english.userjot.com/updates"
											target="_blank"
											rel="noopener noreferrer"
										>
											Updates
				...
				<div className="mt-8 mb-3 flex flex-row items-start justify-between py-3.5 text-muted-foreground text-xs">
