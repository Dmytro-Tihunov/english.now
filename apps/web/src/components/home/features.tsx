...
export function Features() {
  ...
  return (
    <div className="group mx-auto mt-32 max-w-screen px-2 sm:px-6">
      <h1 className="mb-10 text-center font-bold font-lyon text-3xl tracking-tight md:text-5xl">
        English learning is broken.
        <br />
        <span className="text-[#A2A6AB]">
          Speaking stress 😫 Grammar overload 🤷‍♀️ <br />
          ...
          >
            {/* <div
              ...
              style={{
                height: "100px",
                backgroundImage:
                  "linear-gradient(to top, #DCFF6F 0%, #FFFFFF 100%)",
              }}
            /> */}
            <div
            ...
            <div className="mb-6">
              <feature.icon />
              <h2 className="mt-2 mb-2 font-bold font-lyon text-2xl">
                {feature.title}
              </h2>
